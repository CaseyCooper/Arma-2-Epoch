...
[[(_position select 0) - 13, (_position select 1) + 15, 0],4,"Hard","Random",4,"Random","RU_Policeman_DZ","Random","Bandit",_mission] call spawn_group;
[[_position select 0, _position select 1, 0],4,"Hard","Random",4,"Random","RU_Policeman_DZ","Random","Bandit",_mission] call spawn_group;


//Humvee Patrol
[[(_position select 0) + 55, _position select 1, 0],[(_position select 0) + 50, _position select 1, 0],50,2,new_ai_vehicle_random_hero,"Hard","Bandit","Bandit",_mission] call vehicle_patrol;


//Static Guns
[[[(_position select 0) - 48, (_position select 1) + 0.1, 0]],"M2StaticMG","Hard","RU_Policeman_DZ","Bandit",0,2,"Random","Random",_mission] call spawn_static;
[[[(_position select 0) + 2, (_position select 1) +48, 0]],"M2StaticMG","Hard","RU_Policeman_DZ","Bandit",0,2,"Random","Random",_mission] call spawn_static;


//Heli Paradrop
[[(_position select 0), (_position select 1), 0],[10234,0,200],400,"Mi17_DZ",10,"Hard","Random",4,"Random","Bandit","Random","Bandit",true,_mission] spawn heli_para;
...
"Survivors did not stop the bandits in time." // mission fail
  ...
  if(_complete) then {
  [_crate,6,5,[20,crate_items_crop_raider]] call dynamic_crate;
};
