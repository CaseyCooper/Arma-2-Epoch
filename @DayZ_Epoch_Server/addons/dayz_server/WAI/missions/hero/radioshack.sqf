...
_baserunover14 = createVehicle ["MAP_t_carpinus2s",[(_position select 0) + 28, (_position select 1) - 13,-0.02],[], 0, "CAN_COLLIDE"];
	...
	[[(_position select 0) - 1.2, (_position select 1)  - 20, 0],_num,"extreme",["random","at"],4,"random","Bandit","random",["bandit",150],_mission] call spawn_group;
	[[(_position select 0) - 4, (_position select 1) + 16, 0],4,"hard","random",4,"random","Bandit","random","bandit",_mission] call spawn_group;
	[[(_position select 0) - 17, (_position select 1) - 4, 0],4,"random","random",4,"random","Bandit","random","bandit",_mission] call spawn_group;
	[[(_position select 0) + 14, (_position select 1) - 3, 0],4,"random","random",4,"random","Bandit","random","bandit",_mission] call spawn_group;
