...
_baserunover8 = createVehicle ["MAP_t_quercus3s",[(_position select 0) + 22, (_position select 1) + 25,-0.2],[], 0, "CAN_COLLIDE"];
	...
	[[(_position select 0) + 12, (_position select 1) + 22.5, 0],_num,"extreme",["random","at"],4,"random","Bandit","random",["bandit",150],_mission] call spawn_group;
	[[(_position select 0) + 21, (_position select 1) + 11, 0],4,"hard","random",4,"random","Bandit","random","bandit",_mission] call spawn_group;
	[[(_position select 0) - 1.12, (_position select 1) - 0.43, 0],4,"random","random",4,"random","Bandit","random","bandit",_mission] call spawn_group;
	[[(_position select 0) - 13, (_position select 1) - 23, 0],4,"random","random",4,"random","Bandit","random","bandit",_mission] call spawn_group;
