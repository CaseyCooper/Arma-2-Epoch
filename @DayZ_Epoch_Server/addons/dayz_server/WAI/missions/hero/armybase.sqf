...
_baserunover42 = createVehicle ["Land_Fire_barrel_burning",[(_position select 0) - 0.01, (_position select 1) - 0.01,-0.02],[], 0, "CAN_COLLIDE"];
	...
	//Humvee Patrol
	[[(_position select 0) - 22, (_position select 1) - 56, 0],[(_position select 0) + 22, (_position select 1) + 56, 0],50,2,new_ai_vehicle_random_hero,"Hard","Bandit","Bandit",_mission] call vehicle_patrol;
